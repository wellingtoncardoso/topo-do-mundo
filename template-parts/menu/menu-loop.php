<section class="cpw-articles">
  <div class="cpw-container">
    <nav class="cpw-nav-menu">
      ...
      <li class="cpw-nav-menu__item"><a href="#cpw-cat4"><?php esc_html_e( 'Dessert', 'wp-cpw' ); ?></a></li>
    </nav>
  </div>
</section>
...
<section class="cpw-articles">
  <div class="cpw-container">
    <div class="cpw-categories-menu" id="cpw-cat4"><h2><?php esc_html_e( 'Dessert', 'wp-cpw' )?></h2></div>
    <div class="cpw-flex-columns">   
